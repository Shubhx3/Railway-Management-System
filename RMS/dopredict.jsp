...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		<tr>
		<td class="pageHeader">Prediction Portal</td>
		</tr>

		<tr>
		<td class="bodyText"><p>Here you can predict your chances to have ticket.
...
function myfunction() { 
var answer =Math.floor((Math.random() * 1000) + 0);
var pri=answer*100/1000;
var textbox3 = document.getElementById('textbox3');
textbox3.value=pri;
}
function myfunction1(){
var answer1 =Math.floor((Math.random() * 1000) + 0);
var actwo=answer1*100/1000;
var textbox4 = document.getElementById('textbox4');
textbox4.value=actwo;
}
function myfunction2(){
var answer2 =Math.floor((Math.random() * 1000) + 0);
var acthree=answer2*100/1000;
var textbox5 = document.getElementById('textbox5');
textbox5.value=acthree;
 } 
</script>
Train Number:<input type="number" readonly value=<% out.print(tno); %> ><br>
Date of Journey:<input type="date" readonly value=<% out.print(doj); %> ><br>
Number of Passengers:<input type="number" name="n1" value="1" required><br>
<button name="button" id="button1" onclick="myfunction()" value="Predict" >Predict</button>
For GSL:--
<input type="text" name="textbox3" id="textbox3" readonly="true"/><b>%</b><br>
<button name="button" id="button1" onclick="myfunction1()" value="Predict" >Predict</button>
For 2AC:--
<input type="text" name="textbox4" readonly id="textbox4"><b>%</b><br>
<button name="button" id="button1" onclick="myfunction2()" value="Predict" >Predict</button>
For 3AC:--
<input type="text" name="textbox5" readonly id="textbox5"><b>%</b><br>
