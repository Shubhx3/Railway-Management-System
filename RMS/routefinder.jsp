...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		...
		<tr>
		<td class="bodyText"><p>Enter Train Number to Find your Preferred Train</p>
<%@ page import="java.sql.*" %>
<% Class.forName("com.mysql.jdbc.Driver"); %>
        <FORM ACTION="routefinder.jsp" METHOD="POST">
        ...
        <% 
            ...
            ResultSet resultset = 
                statement.executeQuery("select * from trains where tno = '" + id + "'") ; 

            if(!resultset.next()) {
                out.println("Wait for the server. OR " +
                "Please <A HREF='routefinder.jsp'>try again</A>.");
            } else {
        %>
