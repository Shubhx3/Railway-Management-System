...
var answer =Math.floor((Math.random() * 10000000000) + 1);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="36" colspan="3" id="navigation" nowrap="nowrap" class="navText"><a href="index.jsp">HOME</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <a href="Login.jsp">RESERVATION</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://indianrailwaysreservation.in">INFORMATION</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="index.jsp">LOGOUT</a></td>
	  <td width="4">&nbsp;</td>
	<td width="164">&nbsp;</td>
	</tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="440">
		...
		<tr>
                    <td class="bodyText" style="font-size:10pt"><p></p>
                            <%@ page import ="java.sql.*" %>
<%
    String userid = request.getParameter("username");    
    String pwd = request.getParameter("password");
    Class.forName("com.mysql.jdbc.Driver");
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3307/test",
            "root", "123");
    ...
    if (rs.next()) {
      ...
      out.println("Succefully Logged In. Select Your Preffered Option");%>
	  <center><Strong>Reserve Your Ticket</strong><form method="post" action="reservation.jsp">
	  Enter your Train Number
	  <input type="text" name="tno" placeholder='11111'>
		<br>
	  UserID:<input type="text" name="uname" value=<% out.print(userid); %> readonly><br>
	  Passeenger Name:<input type="text" name="pname"><br>
	  Date of Journey:<input type="text" placeholder='yyyy-mm-dd' name="djour"><br>
	  Boarding From  :<select name="src" onchange="return copyrestooff()" class="formText0">
	...
	Destination:<select name="dest" onchange="return copyrestooff()" class="formText0">
      <option value="" selected="selected">-- Select One --</option>
      <option value="Abohar">Abohar</option>
      <option value="Abu Road">Abu Road</option>
      <option value="Anantnag">Anantnag</option>
	...
	Your PNR is:
    <input type="text" name="textbox3" id="textbox3" placeholder='do not eneter anything' readonly="true"/><br>
	<button name="button" id="button1" onclick="myfunction()" value="Generate" >Generate Ticket</button>
	  </form></center>
	  <hr>
	  <center><h3>BOOKED TICKET HISTORY</h3></center>
	  <%
	  ResultSet resultset = 
                st.executeQuery("select * from reservation where  uid = '" + userid + "' ") ; 
        %>
