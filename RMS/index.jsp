...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<td height="36" colspan="3" id="navigation" nowrap="nowrap" class="navText"><a href="index.jsp">HOME</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <a href="Login.jsp">RESERVATION</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="prediction.jsp">PREDICTION</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="FareEnquiry.jsp">FARE</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://www.irctc.co.in/eticketing/contact.jsf">INFORMATION</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	  <td width="4">&nbsp;</td>
	<td width="164">&nbsp;</td>
	</tr>
	<tr bgcolor="#ffffff">
